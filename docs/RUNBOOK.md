...
There is no live gameplay runner in Work Order 001.
...
Do not install `ml` extras for Work Order 001. No learning or inference component uses them.
...
## 7. Input activation boundary

Work Order 001 exposes a programmatic input factory but no live gameplay command. Its default is
...
Any rejection or exception releases held keys. Do not add or invoke a live harness without a separate
authorized work order and a training/private-consent test plan.
...
## 10. Emergency recovery procedure
